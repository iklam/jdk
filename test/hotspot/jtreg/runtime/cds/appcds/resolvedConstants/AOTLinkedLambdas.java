 ...
 *                 IA IB IC ID1 ID2 IE1 IE2 IF1 IF2 IG1 IG2
 *                 FooA FooB
 *                 BarA BarB BarC
...
public class AOTLinkedLambdas {
    ...
    public static void main(String[] args) throws Exception {
        ...
        dumpOut.shouldContain("Cannot aot-resolve Lambda proxy of interface type IC (unsupported interface)");
        dumpOut.shouldContain("Can aot-resolve Lambda proxy of interface type ID2");
        dumpOut.shouldContain("Cannot aot-resolve Lambda proxy of interface type IE2 (unsupported super interface IE1)");
        dumpOut.shouldContain("Cannot aot-resolve Lambda proxy of interface type IF2 (unsupported interface)");
        dumpOut.shouldContain("Cannot aot-resolve Lambda proxy of interface type IG2 (unsupported interface)");
