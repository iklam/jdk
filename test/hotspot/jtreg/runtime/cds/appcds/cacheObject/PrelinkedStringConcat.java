...
class ConcatA {
    ...
    static {
        try {
            //System.out.println(Class.forName("java.lang.invoke.Invokers$Holder"));
            //System.out.println(Class.forName("java.lang.invoke.MethodHandle"));
            //System.out.println(Class.forName("java.lang.invoke.DelegatingMethodHandle$Holder"));
            //System.out.println(Class.forName("java.lang.invoke.BoundMethodHandle$Species_L"));
        } catch (Throwable t) {
            //t.printStacktrace();
        }
        foo("000", "222");
