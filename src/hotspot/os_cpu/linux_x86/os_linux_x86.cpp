...
namespace os::Internal {
  size_t _compiler_thread_min_stack_allowed = 48 * K;
  size_t _java_thread_min_stack_allowed = 40 * K;
#ifdef _LP64
  size_t _vm_internal_thread_min_stack_allowed = 64 * K;
#else
  size_t _vm_internal_thread_min_stack_allowed = (48 DEBUG_ONLY(+ 4)) * K;
#endif // _LP64
}
