...
class EnumIterator {
  ...
  constexpr void assert_in_bounds() const {
    vmassert(_value < Traits::_end, "beyond the end");
  }
...
public:
  ...
  {
    vmassert(_value >= Traits::_start, "out of range");
    vmassert(_value <= Traits::_end, "out of range");
  }
...
public:
  ...
  {
    vmassert(Traits::_start <= _start, "out of range");
    vmassert(_end <= Traits::_end, "out of range");
    vmassert(_start <= _end, "invalid range");
  }
