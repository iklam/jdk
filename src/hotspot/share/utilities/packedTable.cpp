...
PackedTableLookup::PackedTableLookup(uint32_t max_key, uint32_t max_value, const Array<u1>* table) :
  PackedTableLookup(max_key, max_value, table->data(), checked_cast<size_t>(table->length())) {}
