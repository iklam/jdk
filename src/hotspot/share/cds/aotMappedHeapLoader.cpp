...
// This is called when the VM becomes capable of running the garbage collector.
// Verify that the classes of all oops rechable from the roots have already been loaded.
