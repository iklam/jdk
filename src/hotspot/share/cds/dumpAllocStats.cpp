...
#undef fmt_stats
  ...
  msg.info("Platform loader initiated classes = %5d", AOTLoadedClassRecorder::num_platform_initiated_classes());
  msg.info("App      loader initiated classes = %5d", AOTLoadedClassRecorder::num_app_initiated_classes());
