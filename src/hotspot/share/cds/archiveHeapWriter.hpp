...
class ArchiveHeapWriter : AllStatic {
  ...
  template <typename T> static void relocate_field_in_requested_obj(oop requested_obj, size_t field_offset, CHeapBitMap* oopmap);
  template <typename T> static void mark_oop_pointer(oop requested_obj, size_t field_offset, CHeapBitMap* oopmap);
