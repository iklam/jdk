...
bool AOTClassInitializer::can_archive_initialized_mirror(InstanceKlass* ik) {
  ...
  // at runtime.
  //
  // There are cases that cannot be automatically discovered. For example,
  // with -XX:+AOTInvokeDynamicLinking, _run_time_special_subgraph will contain
  // some DirectMethodHandle objects. As a result, the DirectMethodHandle
  // class is automatically marked as aot-inited.
  //
  // However, DirectMethodHandle::IMPL_NAMES points to MethodHandles::IMPL_NAMES,
