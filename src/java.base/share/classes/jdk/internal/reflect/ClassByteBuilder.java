...
public class ClassByteBuilder extends ClassWriter {
    ...
    public byte[] buildMethodAccessor(Method method, MethodType mtype, boolean hasLeadingCaller) {
    ...
    private void addSpecializedInvokeMethod(MethodType mtype, boolean isStatic, boolean hasLeadingCaller, int paramCount) {
